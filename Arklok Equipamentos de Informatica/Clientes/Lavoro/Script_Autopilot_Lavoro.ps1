...
$PATH_FORCE1 = Test-Path "C:\Program Files (x86)\Magma3\Force1\Client\Alaska.User"

if (!$PATH_FORCE1) {
  Write-Host -ForegroundColor Red "`nO Force1 Agent não está instalado, por gentileza rodar o Instalador.bat na pasta Perflogs."
}
